...
digital_rx = reshape(analog_rx,4,[]); % Transformamos a una matrix 4 x n
digital_rx = (digital_rx(1,:) + 1)./2; % Nos quedamos con la primera fila, sumamos 1 a todos los elementos y dividimos por 2 para 
...
% for fila=1:1:length(digital_rx)
%     receivedData = [receivedData ; manchester2bin(digital_rx(fila,:))];
% end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    % JUANMA ARREGLA TU ESTO QUE SABES COMO VA

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%receivedData = manchester2bin(digital_rx);
